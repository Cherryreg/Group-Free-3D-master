...
class ScannetDatasetConfig(object):
    def __init__(self):
        ...
        self.type2class = {'bathtub': 0, 'bed': 1, 'bench': 2, 'bookshelf': 3, 'bottle': 4, 'chair': 5,
                           ...
                           'lamp': 12, 'laptop': 13, 'monitor': 14, 'nightstand': 15, 'plant': 16, 'sofa': 17,
                           'stool': 18, 'table': 19, 'toilet': 20, 'wardrobe': 21}
        ...
        self.mean_size_arr = np.load(os.path.join(ROOT_DIR, 'scannet/scannet_means_22.npz'))[
            'arr_0']  # 18 class‘s means，Need to calculate
        self.type_mean_size = {}
